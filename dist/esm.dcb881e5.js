...
class SignerConnection extends (0, _jsonrpcTypes.IJsonRpcConnection) {
    ...
    sanitizeResponse(response) {
        return typeof response.error !== "undefined" && typeof response.error.code === "undefined" ? (0, _jsonrpcUtils.formatJsonRpcError)(response.id, response.error.message) : response;
    }
}
...
function _(n2, t2) {
    ...
    function r1(t) {
        return this.shouldComponentUpdate = e2, (0, _preact.createElement)(n2, E({}, t));
    }
...
var k = function(n3, t) {
    return n3 ? (0, _preact.toChildArray)(n3).reduce(function(n, e, r) {
...
(0, _preact.options).__e = function(n, t, e) {
    ...
    F(n, t, e);
}, (U.prototype = new (0, _preact.Component)).__c = function(n5, t) {
    var e = this;
...
(0, _preact.options).vnode = function(n8) {
    n8.$$typeof = H;
    ...
    if (t) {
        if (e3.class != e3.className && ($.enumerable = "className" in e3, null != e3.className && (e3.class = e3.className), Object.defineProperty(e3, "className", $)), "function" != typeof t) {
            var r, o, u;
            for(u in e3.defaultValue && void 0 !== e3.value && (e3.value || 0 === e3.value || (e3.value = e3.defaultValue), delete e3.defaultValue), Array.isArray(e3.value) && e3.multiple && "select" === t && ((0, _preact.toChildArray)(e3.children).forEach(function(n) {
...
function l(r3, i2) {
    var o3 = v(t++, 3);
    !(0, _preact.options).__s && x(o3.__H, i2) && (o3.__ = r3, o3.__H = i2, u.__H.__h.push(o3));
}
function y(r4, i3) {
    var o4 = v(t++, 4);
    !(0, _preact.options).__s && x(o4.__H, i3) && (o4.__ = r4, o4.__H = i3, u.__h.push(o4));
}
function d(n) {
...
function A(t5, u4) {
    (0, _preact.options).useDebugValue && (0, _preact.options).useDebugValue(u4 ? u4(t5) : t5);
}
function F(n1) {
    var r7 = v(t++, 10), i5 = m();
...
function _() {
    o.some(function(t6) {
        if (t6.__P) try {
            ...
            return t6.__H.__h = [], (0, _preact.options).__e(u5, t6.__v), !0;
        }
    }), o = [];
}
function g(n) {
...
(0, _preact.options).__r = function(n) {
...
}, (0, _preact.options).diffed = function(t11) {
    f && f(t11);
    var u7 = t11.__c;
    if (u7) {
        var i6 = u7.__H;
        i6 && i6.__h.length && (1 !== o.push(u7) && r === (0, _preact.options).requestAnimationFrame || ((r = (0, _preact.options).requestAnimationFrame) || function(n) {
            var t12, u8 = function() {
...
}, (0, _preact.options).__c = function(t13, u9) {
    u9.some(function(t14) {
        try {
            ...
            u9.some(function(n) {
                n.__h && (n.__h = []);
            }), u9 = [], (0, _preact.options).__e(r9, t14.__v);
        }
    }), e && e(t13, u9);
}, (0, _preact.options).unmount = function(t15) {
    a && a(t15);
    var u10 = t15.__c;
    if (u10) {
        var r10 = u10.__H;
        if (r10) try {
            ...
            (0, _preact.options).__e(t16, u10.__v);
        }
    }
};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dCyvf"], null, "parcelRequirea667")
